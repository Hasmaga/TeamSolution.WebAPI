            ...
            modelBuilder.Entity("TeamSolution.Model.Order", b =>
                {
                    ...
                    b.Property<Guid?>("TourGetOrderId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("TourGetOrderId");

                    b.Property<Guid?>("TourShipOrderId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("TourShipOrderId");
                    ...
                    b.HasIndex("TourGetOrderId");

                    b.HasIndex("TourShipOrderId");
            ...
            modelBuilder.Entity("TeamSolution.Model.Order", b =>
                {
                    ...
                    b.HasOne("TeamSolution.Model.TourShipper", "TourGetOrder")
                        .WithMany("TourGetOrders")
                        .HasForeignKey("TourGetOrderId");

                    b.HasOne("TeamSolution.Model.TourShipper", "TourShipOrder")
                        .WithMany("TourShipOrders")
                        .HasForeignKey("TourShipOrderId");
                    ...
                    b.Navigation("TourGetOrder");

                    b.Navigation("TourShipOrder");
                });
            ...
            modelBuilder.Entity("TeamSolution.Model.TourShipper", b =>
                {
                    ...
                    b.Navigation("TourGetOrders");

                    b.Navigation("TourShipOrders");
                });
